  ...
  switch (toolName) {
    case 'queryStudentsAndEnrollments': {
      ...
      const allStudents: Array<{
        ...
        const boardName = s.board_name || (s.board_id === 'punjab' ? 'Punjab Board' : s.board_id === 'sindh' ? 'Sindh Board' : s.board_id === 'kpk' ? 'KPK Board' : s.board_id === 'olevel' ? 'O Levels' : s.board_id === 'alevel' ? 'A Levels' : s.board_id === 'ielts' ? 'IELTS' : 'Federal Board (FBISE)');
    ...
    case 'queryClassOfferingsAndTimetables': {
      ...
      const offerings = offeringsRes.rows.map((o: any) => ({
        id: o.id,
        board: o.board_name || (o.board_id === 'punjab' ? 'Punjab Board' : o.board_id === 'sindh' ? 'Sindh Board' : o.board_id === 'kpk' ? 'KPK Board' : o.board_id === 'olevel' ? 'O Levels' : o.board_id === 'alevel' ? 'A Levels' : o.board_id === 'ielts' ? 'IELTS' : 'Federal Board (FBISE)'),
    ...
    case 'queryStudentsAndEnrollments': {
      ...
      allProfiles.forEach((s: any) => {
        ...
        const boardName = s.board_id
          ? boardMap.get(s.board_id) || (s.board_id === 'punjab' ? 'Punjab Board' : s.board_id === 'sindh' ? 'Sindh Board' : s.board_id === 'kpk' ? 'KPK Board' : s.board_id === 'olevel' ? 'O Levels' : s.board_id === 'alevel' ? 'A Levels' : s.board_id === 'ielts' ? 'IELTS' : 'Federal Board (FBISE)')

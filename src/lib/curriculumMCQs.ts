...
export function generateCurriculumFallbackMCQs(
  ...
  while (questions.length < count && dynIdx <= maxIterations) {
    ...
    // ── 8. ISLAMIAT ────────────────────────────────────────────────────────────
      ...
      const islPool = [
        {
          q: `قرآن مجید کی سورتوں کی کل تعداد کتنی ہے؟`,
          opts: { A: '114 سورتیں', B: '112 سورتیں', C: '116 سورتیں', D: '120 سورتیں' },
          ans: 'A' as const,
          exp: 'قرآن مجید میں کل 114 سورتیں (86 مکی اور 28 مدنی) ہیں۔',
        },
        {
          q: `حضور نبی اکرم ﷺ پر وحی لانے والے مقرب فرشتے کا نام کیا ہے؟`,
          opts: { A: 'حضرت جبرائیل علیہ السلام', B: 'حضرت میکائیل علیہ السلام', C: 'حضرت اسرافیل علیہ السلام', D: 'حضرت عزرائیل علیہ السلام' },
          ans: 'A' as const,
          exp: 'حضرت جبرائیل علیہ السلام انبیاء کرام پر وحیِ الٰہی لانے پر مامور مقرب فرشتے ہیں۔',
        },
        {
          q: `اسلام کے پانچ بنیادی ارکان میں سے دوسرا رکن کون سا ہے؟`,
          opts: { A: 'نماز (اقامتِ صلوٰۃ)', B: 'کلمہ شہادت', C: 'زکوٰۃ', D: 'روزہ (صوم)' },
          ans: 'A' as const,
          exp: 'حدیثِ نبویؐ کی روشنی میں کلمہ شہادت کے بعد اسلام کا دوسرا بنیادی ستون اور رکن نماز ہے۔',
        },
        {
          q: `صاحبِ نصاب مسلمان پر سونے کا شرعی نصاب کتنے تولے مقرر ہے؟`,
          opts: { A: 'ساڑھے سات (7.5) تولے سونا', B: 'ساڑھے باون (52.5) تولے سونا', C: 'دس (10) تولے سونا', D: 'پانچ (5) تولے سونا' },
          ans: 'A' as const,
          exp: 'شریعتِ اسلامیہ میں سونے کا نصاب زکوٰۃ ساڑھے سات تولے مقرر ہے۔',
        },
        {
          q: `حق و باطل کا پہلا فیصلہ کن معرکہ غزوہ بدر کس ہجری سال میں پیش آیا؟`,
          opts: { A: '2 ہجری', B: '3 ہجری', C: '5 ہجری', D: '8 ہجری' },
          ans: 'A' as const,
          exp: 'غزوہ بدر 17 رمضان المبارک 2 ہجری کو پیش آیا جس میں مسلمانوں کو فتحِ مبین حاصل ہوئی۔',
        },
        {
          q: `عقیدہ ختمِ نبوت کا کیا مفہوم ہے؟`,
          opts: { A: 'حضرت محمد مصطفیٰ ﷺ اللہ کے آخری نبی و رسول ہیں', B: 'نبوت کا سلسلہ تا قیامت جاری ہے', C: 'نئی شریعت کا نزول ممکن ہے', D: 'صرف کتاب کا اختتام' },
          ans: 'A' as const,
          exp: 'عقیدہ ختمِ نبوت کا مطلب ہے کہ حضرت محمد ﷺ اللہ کے آخری نبی ہیں اور آپ ﷺ کے بعد کوئی نیا نبی نہیں آئے گا۔',
        },
        {
          q: `صلح حدیبیہ کے موقع پر مسلمانوں کی طرف سے بیعتِ رضوان کس درخت کے نیچے لی گئی؟`,
          opts: { A: 'ببول (کیکر) کا درخت', B: 'کھجور کا درخت', C: 'زیتون کا درخت', D: 'انجیر کا درخت' },
          ans: 'A' as const,
          exp: 'بیعتِ رضوان 6 ہجری میں حدیبیہ کے مقام پر ببول کے درخت کے نیچے حضرت عثمانؓ کی شہادت کی افواہ پر لی گئی۔',
        },
        {
          q: `قرآن مجید کی سب سے طویل سورت کون سی ہے؟`,
          opts: { A: 'سورۃ البقرہ', B: 'سورۃ آل عمران', C: 'سورۃ النساء', D: 'سورۃ المائدہ' },
          ans: 'A' as const,
          exp: 'سورۃ البقرہ قرآن مجید کی سب سے طویل سورت ہے جس میں 286 آیات مبارکہ ہیں۔',
        },
        {
          q: `قرآن مجید کی سب سے پہلی نازل ہونے والی آیات کس سورت کی ابتدائی پانچ آیات ہیں؟`,
          opts: { A: 'سورۃ العلق', B: 'سورۃ المدثر', C: 'سورۃ المزمل', D: 'سورۃ الفاتحہ' },
          ans: 'A' as const,
          exp: 'غارِ حرا میں سب سے پہلی وحی سورۃ العلق کی پہلی پانچ آیات پر مشتمل تھی۔',
        },
        {
          q: `چاندی کا شرعی نصاب زکوٰۃ کتنا مقرر ہے؟`,
          opts: { A: 'ساڑھے باون (52.5) تولے چاندی', B: 'ساڑھے سات تولے چاندی', C: 'چالیس تولے چاندی', D: 'سو تولے چاندی' },
          ans: 'A' as const,
          exp: 'شریعتِ مطہرہ میں چاندی کا نصاب زکوٰۃ ساڑھے باون تولے ہے۔',
        },
        {
          q: `عشر سے کیا مراد ہے؟`,
          opts: { A: 'زرعی پیداوار پر زکوٰۃ (دسواں یا بیسواں حصہ)', B: 'سونے پر ٹیکس', C: 'تجارت پر محصول', D: 'معدنیات کا خمس' },
          ans: 'A' as const,
          exp: 'عشر شرعی اصطلاح میں زرعی پیداوار کی زکوٰۃ کو کہا جاتا ہے۔',
        },
        {
          q: `غزوہ احد کس ہجری سال میں لڑی گئی؟`,
          opts: { A: '3 ہجری', B: '2 ہجری', C: '4 ہجری', D: '5 ہجری' },
          ans: 'A' as const,
          exp: 'غزوہ احد شوال 3 ہجری میں کوہِ احد کے دامن میں پیش آئی۔',
        },
      ];
      const iq = islPool[(dynIdx - 1) % islPool.length];
      addSafeQuestion({
        id: `cur_isl_${dynIdx}`,
        question: iq.q,
        options: iq.opts,
        correctAnswer: iq.ans,
        explanation: iq.exp,
        topic: chapterLabel,
        chapter: chapterLabel,
      });

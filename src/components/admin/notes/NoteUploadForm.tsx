...
export const NoteUploadForm: React.FC<NoteUploadFormProps> = ({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 p-1">
      {error && (
        <div className="p-3 text-xs font-semibold text-red-700 bg-red-50 border border-red-100 rounded-xl flex items-center gap-2">
        ...
        >
          <option value="" disabled>
            {scopedOfferings.length === 0
              ? 'No offerings found for selected Grade & Stream...'
      ...
      {!offeringId ? (
        <div className="p-6 bg-[#FAFAFA] border border-dashed border-[#E5E5E5] rounded-2xl text-center my-4">
          ...
          <p className="text-xs font-bold text-[#111111]">Scope to a Specific Offering</p>
        ...
        <div className="space-y-4 pt-1 animate-in fade-in duration-200">
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-[#525252] block">Chapter Name / Topic <span className="text-red-500">*</span></label>
            <input
              type="text"
          ...
          {/* Title */}
          <div className="space-y-1">
            <label className="text-xs font-bold text-[#525252] block">Note Title <span className="text-red-500">*</span></label>
            <input
              type="text"

  ...
  return (
    <StudentShell>
      ...
      <SectionHeader
        ...
        description="Access scheduled subject assessments, download question papers, and submit your handwritten answer sheets."
      />
        ...
        <div className="lg:col-span-6 xl:col-span-5 space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-extrabold text-[#111111] flex items-center gap-2">
              <span>Available Test Papers</span>
            ...
            <div className="bg-white rounded-2xl border border-[#E5E5E5] p-8 text-center shadow-xs">
              ...
              <p className="text-xs text-[#737373] mt-1">
                {searchTerm || activeSubject !== 'All' || statusFilter !== 'all'
                  ...
                  : 'No tests have been scheduled yet for your grade and stream.'}
              </p>
              {(searchTerm || activeSubject !== 'All' || statusFilter !== 'all') && (
                <button
                  onClick={() => {

/**
 * Full Generator for all 12 Chapters of IELTS Reading Academic (330 MCQs)
 */
const fs = require('fs');
const path = require('path');

// We will construct the 12 chapters data
const allChapters = [];
...
console.log('Building all chapters and compiling to src/data/banks/ielts/readingAcademic.ts...');

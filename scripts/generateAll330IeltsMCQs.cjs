...
// Complete academic passages, stems, and options generator for all 12 IELTS Reading (Academic) chapters
// Each question is passage-based, tests authentic IELTS skills, has 4 clear options, a verified answer, and an in-depth academic explanation.
...
console.log('Writing script foundation...');

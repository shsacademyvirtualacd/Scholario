/**
 * Complete Generator for 330 Authentic IELTS Reading (Academic) Questions
 */
const fs = require('fs');
...
// 12 Chapters with detailed topics, passages, and verified question structures
const chapterConfigs = [
  {
    ...
    subtopics: [
      {
        title: 'Ocean Acidification & Carbonate Chemistry',
      ...
      {
        title: 'Tropical Peatlands Carbon Storage',
      ...
      {
        title: 'Arctic Permafrost Thawing & Methane',
      ...
      {
        title: 'Mangrove Forest Wave Attenuation',
      ...
      {
        title: 'Monoculture Afforestation Vulnerabilities',
      ...
      {
        title: 'Biological Soil Crusts & Wind Erosion',
      ...
      {
        title: 'Atmospheric Aerosols Radiative Forcing',
      ...
      {
        title: 'Deep-Sea Hydrothermal Vent Ecology',
      ...
      {
        title: 'Glacial Runoff Seasonal Shifts',
      ...
      {
        title: 'Urban Heat Islands & Albedo Cooling',
      ...
      {
        title: 'Desert Fog Harvesting Mechanics',
      ...
      {
        title: 'Stratospheric Sulfur Solar Geoengineering',
      ...
      {
        title: 'Estuarine Eutrophication & Hypoxia',
      ...
      {
        title: 'Tundra Soil Nitrogen Constraints',
      ...
      {
        title: 'Boreal Forest Wildfire Duff Combustion',
      ...
      {
        title: 'Wetland Hydrological Restoration',
      ...
      {
        title: 'Epilithic Desert Varnish Formation',
      ...
      {
        title: 'Southern Ocean Iron Limitation',
      ...
      {
        title: 'Thermohaline Deep Water Formation',
      ...
      {
        title: 'Pyrocumulonimbus Wildfire Plumes',
      ...
      {
        title: 'Carbon Offset Additionality Deficits',
      ...
      {
        title: 'Coral Reef Bleaching Dynamics',
      ...
      {
        title: 'Kelp Bed Carbon Export to Abyss',
      ...
      {
        title: 'Desalination Hypersaline Brine Discharge',
      ...
      {
        title: 'Marine Microplastics Toxin Vectors',
      ...
      {
        title: 'Salt Marsh Sediment Accretion',
      ...
      {
        title: 'Direct Air Capture Energy Penalties',
...
console.log('Building remaining chapters programmatically...');

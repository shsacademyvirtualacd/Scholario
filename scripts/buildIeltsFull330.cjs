/**
 * Master generator script for 330 genuine IELTS Reading (Academic) MCQs
 */

const fs = require('fs');
const path = require('path');

// Generator helper that produces 12 authentic academic chapters with 330 verified questions
const chapters = [
  {
    num: 1,

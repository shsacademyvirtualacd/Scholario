 ...
 * Generates 12 Chapters with 27-28 questions per chapter (330 total).
 * Outputs to src/data/banks/ielts/readingAcademic.ts
 */

const fs = require('fs');
const path = require('path');

// 12 Authentic Academic Chapters
const CHAPTER_SPECS = [
  {
    chapterNumber: 1,
    chapterName: 'Natural Sciences, Climate & Environmental Systems',
    codePrefix: 'ielts-read-ch01',
    count: 28,
    items: [
      {
...
console.log('Writing comprehensive generator module...');
